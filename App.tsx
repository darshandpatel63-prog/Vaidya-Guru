          ...
          <div className="space-y-6 animate-in fade-in duration-500 pt-4">
            ...
            <div className="px-4 sticky top-0 z-40 py-2">
              <div className="relative">
                 ...
                 <svg className="w-5 h-5 text-stone-400 absolute left-4 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              </div>
            </div>
